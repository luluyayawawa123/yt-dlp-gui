...
- 双击打开 DMG，
  - 将“YT-DLP GUI”【拖拽到“应用程序（Applications）”文件夹】完成安装（DMG 窗口通常自带 Applications 快捷方式，把图标拖到那个文件夹图标上即可）
...
- ⚠️ 重要提醒：本应用在 Intel Mac 上开发，M 系列 Mac 运行时可能需要 Rosetta 翻译，首次或每次启动可能需等待约 10 秒，请耐心等待
...
> ⚠️ 遇到“无法解析/403/No formats found”等下载失败时，请先用 Homebrew 更新 yt-dlp 与 ffmpeg 后再试。
...
1. 打开应用，在“浏览器”处选择 cookies 来源：Safari（推荐）/Chrome/Edge
   - ⚠️ 必须先在所选浏览器中登录 YouTube 账号（下载会员/受限视频需要登录）
...
1. ⚠️ **下载失败/报错（无法解析、403、No formats found 等）**
